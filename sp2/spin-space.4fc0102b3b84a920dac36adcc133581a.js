...
.err {
    color: #ff0;
}`,d([f({type:Number})],l.prototype,"clockwise",2),d([f({type:Number})],l.prototype,"frames",2),d([f({type:Number})],l.prototype,"duration",2),d([f({type:Number})],l.prototype,"max",2),d([f({type:Boolean,attribute:"with-duration"})],l.prototype,"withDuration",2),d([f({type:String})],l.prototype,"src",2),d([f({type:String})],l.prototype,"name",2),d([f()],l.prototype,"current",2),d([j()],l.prototype,"state",2),d([j()],l.prototype,"maxdur",2),l=d([q("spin-space")],l);export{l as SpinSpace};
/**
 * @license
